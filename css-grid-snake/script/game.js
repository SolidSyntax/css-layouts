...
const arenaFactory = (size) => {
    ...
    const placeNewPowerUp = (snake) => {
        ...
        const row = randomIntBetween(2, 99);
        const column = randomIntBetween(2, 99);
...
const arena = arenaFactory(100);
const snakeInput = snakeInputFactory();

let snake = [{row: 50, column: 50}];
...
//start
const timeoutId = setInterval(gameTick, 50);
